...
public class BPago {
    ...
    public void create(List<String> parametros) throws SQLException, ParseException {
        dTipoPago.create(parametros.get(0), Integer.parseInt(parametros.get(1)), parametros.get(2), parametros.get(3), parametros.get(4));
        dTipoPago.disconnect();
    }

    public void edit(List<String> parametros) throws SQLException, ParseException {
        dTipoPago.edit(Integer.parseInt(parametros.get(0)), parametros.get(1), Integer.parseInt(parametros.get(2)), parametros.get(3), parametros.get(4), parametros.get(5));
        dTipoPago.disconnect();
    }
