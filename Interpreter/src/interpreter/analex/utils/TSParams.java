...
public class TSParams {
    ...
    /**
     * Devuelve la posición (índice de L) donde se encuentra el Params Si no
     * existe devuelve -1.
     *
     * @param Str
     * @return
    ...
    /**
     * Inserta un nuevo Params Devuelve la posición donde está/fue alojado Si no
     * se pudo insertar return -1.
     *
     * @param Str
     * @return
     */
